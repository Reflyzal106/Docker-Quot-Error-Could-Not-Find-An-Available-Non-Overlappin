# [SOLVED] Docker-Quot-Error-Could-Not-Find-An-Available-Non-Overlappin
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/docker-quot-error-could-not-find-an-available-non-overlappin)
>
...
The issue is caused by Docker's inability to allocate a new IP address for the privoxy service. Try setting the `ipam` configuration in the `docker-compose.yml` file to resolve the issue.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/docker-quot-error-could-not-find-an-available-non-overlappin)**
